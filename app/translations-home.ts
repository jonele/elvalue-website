...
export const t = {
  ...
  eveyDedicated: {
    ...
    title: {
      el: "Γνωρίστε την EvE — Η Προσωπική Σας AI",
      en: "Meet EvE — Your Personal AI",
      ru: "Познакомьтесь с EvE — ваш персональный AI",
      ar: "تعرّف على EvE — ذكاؤك الاصطناعي الشخصي",
    },
    desc: {
      el: "Δεν είναι chatbot. Είναι concierge. Η EvE είναι η προσωπική σας AI βοηθός που θυμάται τα πάντα, διαχειρίζεται τη μέρα σας, και γίνεται πιο έξυπνη όσο μιλάτε. Διαθέσιμη στο Telegram.",
      en: "Not a chatbot. A concierge. EvE is your personal AI assistant that remembers everything, manages your day, and grows smarter the more you talk to her. Available on Telegram.",
      ru: "Не чат-бот. Консьерж. EvE — ваш персональный AI-ассистент, который запоминает всё, управляет вашим днём и становится умнее с каждым разговором. Доступна в Telegram.",
      ar: "ليست روبوت دردشة. إنها كونسيرج. EvE مساعدتك الذكية الشخصية التي تتذكر كل شيء وتدير يومك وتصبح أذكى كلما تحدثت معها. متاحة على تيليجرام.",
    },
    cta: {
      el: "Δοκιμάστε την EvE Δωρεάν",
      en: "Try EvE Free",
      ru: "Попробуйте EvE бесплатно",
      ar: "جرّب EvE مجاناً",
    },
    features: [
      {
        ...
        desc: {
          el: "Τις προτιμήσεις σας, τις ρουτίνες, τις επαφές — η EvE χτίζει μια εικόνα για σας.",
          en: "Your preferences, routines, contacts — EvE builds a picture of you over time.",
          ru: "Ваши предпочтения, рутины, контакты — EvE создаёт ваш портрет со временем.",
          ar: "تفضيلاتك وروتينك وجهات اتصالك — EvE تبني صورة عنك مع الوقت.",
        },
      },
      {
